package com.dfgcontroller.data
...
class SettingsRepository(private val context: Context) {
    ...
    val killWhitelist: Flow<Set<String>> = context.dataStore.data.map { it[PreferencesKeys.KILL_WHITELIST] ?: setOf("com.android.systemui", "com.google.android.gms", "com.dfgcontroller") }
